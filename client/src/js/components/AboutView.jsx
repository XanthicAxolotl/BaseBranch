    ...
    return (
      ...
      <div className="row">
        <div className="col-md-2">
            ...
            <img className="picture" src={'./images/wendyleung.jpg'} />
          <hr />
          <div className="row">
        ...
        <div className="col-md-2">
          ...
          <img className="picture" src={'./images/julianething.jpg'} />
          <hr />
          <div className="row">
        ...
        <div className="col-md-2">
          ...
          <img className="picture" src={'./images/michaelroberts.jpg'} />
          <hr />
          <div className="row">
      ...
      <div className="row">
        <div className="col-md-2">
          ...
          <img className="picture" src={'./images/kalevrk.jpg'} />
          <hr />
          <div className="row">
        ...
        <div className="col-md-2">
          ...
          <img className="picture" src={'./images/robertzheng.jpg'} />
          <hr />
          <div className="row">
        ...
        <div className="col-md-2">
          <h4>Xander<br />The Xanthic Axolotl</h4>
          <img className="picture" src={'./images/xanderbig.jpg'} />
          <hr />
          <div className="row">
            <a className="col-md-two" href="http://github.com/XanthicAxolotl"><span className="fa fa-github-alt"></span></a>
            <a className="col-md-two" href="http://en.wikipedia.org/wiki/Axolotl"><span className="fa fa-book"></span></a>
          </div>
          <hr />
          <h5>Team Mascot</h5>
          <p>Morale Architect<br />Full Stack Engineer</p>
          <hr />
          <p>"I'm feeling particularly xanthic today."</p>
          <hr />
        </div>
      </div>
      </div>
